...
const policies = [
  { icon: AlertCircle, type: 'warning', text: 'Tickets are non-refundable unless the flight is cancelled by the carrier (Rano Air Limited).' },
  { icon: CheckCircle, type: 'success', text: 'Applications for refunds must be made online or at any of our sales outlets or airport stations.' },
  { icon: Info, type: 'info', text: 'Passengers requesting a refund during flight cancellation must provide a valid government-issued Identification Card. Third-party refunds are not applicable.' },
  { icon: Info, type: 'info', text: 'We reserve the right to make a refund in the same manner and in the same currency used to pay for the ticket.' },
  { icon: AlertCircle, type: 'warning', text: 'Revalidation/date change and No-show fees are not refundable, even in the event of flight cancellation.' },
];

const typeStyles = {
  warning: { bg: 'rgba(165,0,80,0.06)', border: 'rgba(165,0,80,0.2)', iconColor: '#A50050', iconBg: 'rgba(165,0,80,0.12)' },
  success: { bg: 'rgba(16,185,129,0.05)', border: 'rgba(16,185,129,0.2)', iconColor: '#10B981', iconBg: 'rgba(16,185,129,0.12)' },
  info: { bg: 'rgba(59,130,246,0.05)', border: 'rgba(59,130,246,0.2)', iconColor: '#3B82F6', iconBg: 'rgba(59,130,246,0.12)' },
};
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          ...
          <div className="space-y-4 mb-12">
            {policies.map((policy, i) => {
              ...
              return (
                ...
                >
                  <div className="w-9 h-9 rounded-xl flex items-center justify-center shrink-0 mt-0.5" style={{ background: style.iconBg }}>
          ...
          >
            ...
            <a
              ...
              className="flex items-center gap-2.5 bg-white text-primary font-bold py-3 px-6 rounded-2xl hover:scale-105 transition-all duration-200 shadow-lg whitespace-nowrap"
            >
          ...
          >
            <p className="text-text-muted text-sm font-medium mb-3">Questions about your refund? Contact our team:</p>
            <div className="flex flex-col sm:flex-row gap-2 justify-center">
              <a href="mailto:customercare@ranoair.com" className="text-primary font-bold text-sm hover:underline">customercare@ranoair.com</a>
              <span className="text-text-muted hidden sm:inline">·</span>
              <a href="tel:09169844058" className="text-primary font-bold text-sm hover:underline">091-6984-4058</a>
            </div>
          </motion.div>
        </div>
      </section>
