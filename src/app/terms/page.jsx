...
const sections = [
    ...
    content: [
      {
        ...
        body: 'All flight bookings must be paid in full at the time of reservation. A booking is only confirmed upon receipt of complete payment and the issuance of a booking confirmation number or e-ticket. Rano Air Limited reserves the right to cancel any booking that has not been fully paid within the required timeframe.',
      },
      {
        heading: '2. Fare Conditions',
        body: 'All fares displayed are inclusive of applicable taxes and government-mandated charges unless otherwise stated. Fares are subject to availability and may change without prior notice. The applicable fare is the fare in effect at the time of confirmed purchase, not at the time of browsing or enquiry.',
      },
      {
        heading: '3. Ticket Accuracy',
        body: 'Passengers are solely responsible for ensuring the accuracy of all travel details — including passenger names, travel dates, routes, and contact information — at the time of booking. Name corrections or changes after ticket issuance may attract fees. Name changes that constitute a transfer of the ticket to a different individual are not permitted.',
      },
      {
        heading: '4. Pricing Errors',
        body: 'In the event of a manifest pricing error on the Rano Air booking platform, Rano Air reserves the right to cancel affected bookings and offer a full refund or the option to repurchase at the correct fare. We will notify affected passengers as promptly as possible.',
      },
      {
        heading: '5. Third-Party Agents',
        body: 'Bookings made through authorised travel agents are subject to the terms and conditions of both Rano Air and the respective agency. Rano Air is not responsible for errors, omissions, or additional charges levied by third-party agents.',
      },
    ],
  },
  {
    ...
    content: [
      {
        heading: '1. Check-In Times',
        body: 'Passengers are required to complete check-in at least 45 minutes before the scheduled departure time. Check-in counters close 30 minutes before departure. Passengers who arrive after check-in closure will be denied boarding and treated as a no-show, with no right to compensation.',
      },
      {
        heading: '2. Identification Requirements',
        body: 'All passengers must present a valid, original, government-issued photo identification document at check-in. Accepted forms of ID include: National Identity Card (NIN), Permanent Voter\'s Card, International Passport, or a valid Driver\'s License. Photocopies and expired documents are not accepted.',
      },
      {
        heading: '3. Boarding',
        body: 'Boarding commences 20 minutes before departure. Passengers must be at the designated gate before boarding closes. Rano Air reserves the right to deny boarding to any passenger who: (a) appears to be under the influence of alcohol or narcotics; (b) displays disruptive or threatening behaviour; (c) fails to comply with security or safety instructions; or (d) poses a risk to the health or safety of fellow passengers or crew.',
      },
      {
        heading: '4. Baggage',
  ...
  },
  {
    ...
    content: [
      ...
      {
        heading: '3. Limitations of Liability',
        body: 'Rano Air shall not be liable for any delays, cancellations, or disruptions caused by Force Majeure events. No compensation for accommodation, meals, ground transport, consequential losses, missed connections, or other indirect expenses will be provided under Force Majeure circumstances. Passengers are encouraged to purchase comprehensive travel insurance to cover such eventualities.',
      },
      {
        heading: '4. Exclusion of Cash Refunds Under Force Majeure',
        body: 'Cash or card refunds are not automatically available for cancellations attributable solely to Force Majeure events. Rano Air\'s obligation is limited to re-routing or providing a travel credit. However, Rano Air will assess each case individually and may, at its sole discretion, offer alternative remedies where appropriate.',
      },
    ],
  },
  {
    ...
    content: [
      {
        heading: '1. Non-Refundable Tickets',
        body: 'Tickets purchased on Rano Air are non-refundable unless the flight is cancelled by Rano Air Limited (the carrier). Passenger-initiated cancellations, no-shows, and voluntary changes of travel plans do not entitle the passenger to a cash refund.',
      },
      {
        heading: '2. Refund Applications',
        body: 'Applications for refunds (in the event of carrier-initiated cancellations) must be submitted online, at any of our sales outlets, or at airport stations. The completed Refund Application Form — available for download on the Refund Policy page — must be submitted along with valid government-issued ID.',
      },
      {
        heading: '3. Third-Party Restrictions',
        body: 'Refunds will only be made to the original payment method and the original payee. Third-party refunds are not applicable. For company bookings, a letter of authorisation on company letterhead is required.',
      },
      {
        heading: '4. Refund Method',
        body: 'Rano Air reserves the right to make refunds in the same manner and currency used to purchase the original ticket. Card refunds will be processed back to the originating card. Bank transfer refunds require a valid account in the passenger\'s name.',
      },
      {
        heading: '5. Processing Time',
        body: 'All refund requests are subject to verification by Rano Air Ltd. Refund processing takes a minimum of one month (30 days) from the date of submission. Rano Air is not responsible for delays caused by banking institutions or card networks.',
      },
      {
        heading: '6. Non-Refundable Fees',
        body: 'Revalidation/date change fees, no-show fees, and administration charges are non-refundable under all circumstances, including in the event of flight cancellation by the carrier.',
      },
    ],
  },
];
      ...
      >
        <div className="flex items-center gap-3">
          <div
            ...
            style={{
              background: open ? '#A50050' : 'rgba(165,0,80,0.1)',
              color: open ? 'white' : '#A50050',
            }}
          >
            {index + 1}
          </div>
